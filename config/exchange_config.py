...
# =============================================================================
FILTERING_CONFIG = {
    # Исключаемые суффиксы - только настоящие стейблкоины
    "excluded_suffixes": [
        "BUSD", "USDC", "FDUSD", "TUSD", "USDP", "DAI", "FRAX", "LUSD"
        # USDT оставляем - пары типа BTCUSDT нужны для торговли
    ],
    ...
    # Минимальные требования для фильтрации
    "min_24h_volume_usdt": 1000000,  # 1M USD - более строгий фильтр
